package com.calbak.utils.aop;

import com.calbak.utils.aop.annotation.MethodInfoLogging;
...
public class LogAspect {
     ...
     */
    @Around("@annotation(com.calbak.utils.aop.annotation.MethodInfoLogging) && @annotation(target)")
     ...
     */
    @Around("execution( * com.calbak.domain.*.*Repository.*(..))")
